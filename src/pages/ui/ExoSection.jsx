    ...
    <section className="home">
      <Container>
        ...
        {/* <div className="home__more">
          <div className="home__more-content d-flex">
            ...
            <div className="home__more-img">
              <img src={bgDevices} alt="" className="bg__devices w-100" />
              <img src={bgDevicesSm} alt="" className="bg-sm" />
            </div>
          </div>
